...
def enumerate(s, start=0):
    ...
    """
    # BEGIN Question 0
# In utils.py, use the zip function to implement enumerate, which takes a sequence s and a starting index start. It returns a list of pairs, in
# which the i-th element is i+start paired with the i-th element of s. 
